...
import { StatusSwitch } from "../../../styles/MainStyles";
...
function Contract({
  ...
  const initStateContract = {id: chosenCompany.id, start_at: new Date(), sales: loggedinSalesPerson.id, vat: false }
  ...
  useEffect(() => {
    if(chosenContract){
      ...
      const periodicityName = chargePeriods.find(period => period.value === chosenContract.periodicity).name;
            ...
            <Grid container className={classes.formContainer}>
                      ...
                      <Grid item xs={6} className={classes.PaddingLeft10px}>
                        {salesmenArr && (
                          <AutoCompleteUnit
                            ...
                            options={salesmenArr}
                            formObject={contract}
                            handler={e => {e ? handleContract(e.id, "sales") : handleContract(e, "sales") }}
                            error = {errors.sales}
                ...
                <Grid container>
                  ...
                  <Grid item xs={12}>
                    <Grid container className={classes.paddingBottom30px}>
                      ...
                      <Grid item xs={1}>
                        <Typography className={classes.perStyle}>
                          per
                        </Typography>
                      </Grid>
                      <Grid item xs={5}>
                ...
                <Grid item xs={12} className={`${classes.padding3000px} ${classes.vatGroupWrapper}`}>
                  ...
                  <Grid item xs={6} className={classes.vatGroup}>
                      ...
                      <StatusSwitch 
                        ...
                        <Typography className={classes.vatLabel2}>
                          VAT
                        </Typography>
                  </Grid>
              ...
              <Grid container>
                <Grid item xs={12} className={classes.padding3000px}>
                  <Grid container className={classes.paddingBottom20px}>
                    <Grid item xs={3}>
                      <Typography className={classes.indiLabel}>
                        Yearly Amount
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                          ...
                          <Typography className={classes.amountType}>
                            ...
                            contract.periodicity
                              ? `${
                                  ...
                                  currenciesArr.find(
                                    (currency) =>
                                      currency.code === contract.currency
                                  ).symbol
                                  :
          ...
          <Grid container>
            <Grid item xs={12} className={classes.padding3000px}>
              <Grid 
                ...
                >
                <Grid item xs={3}>
                  <Typography className={classes.membersStyle}>
                    Members
                  </Typography>
                </Grid>
                <Grid container >
                  <Grid item xs={6} > 
                    ...
                    {chosenCompany && chosenCompany.members && <Grid item xs={12}>
