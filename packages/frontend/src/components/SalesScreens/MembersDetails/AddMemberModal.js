  ...
  return (
    ...
    >
      <Grid container justifyContent="center">
        ...
        <Grid item xs={10}>
          <Grid container spacing={2}>
            <Grid item xs={6} className={classes.fieldWrapper}>
              <TextInputUnit className={classes.textFieldStyle} name="member_name" label="Full Name" value={newMember.member_name} onChange={updateMemberField} error={errors.member_name} />
            </Grid>
            <Grid item xs={6} className={classes.fieldWrapper}>
              <TextInputUnit className={classes.textFieldStyle} name="username" label="Username" value={newMember.username} onChange={updateMemberField} error={errors.username} />
            </Grid>
          </Grid>
        </Grid>
        <Grid item xs={10}>
          <Grid container spacing={2}>
            <Grid item xs={6} className={classes.fieldWrapper}>
              <TextInputUnit className={classes.textFieldStyle} name="email" email="email" label="Email" value={newMember.email} onChange={updateMemberField} error={errors.email} />
            </Grid>
            <Grid item xs={6} className={classes.fieldWrapper}>
              <TextInputUnit className={classes.textFieldStyle} name="position" label="Position" value={newMember.position} onChange={updateMemberField} error={errors.position} />
            </Grid>
          </Grid>
        </Grid>
        ...
        <Grid item xs={12}>
          <Grid container justifyContent="center">
            <FilledButton disabled={!validationResult} className={classes.addBtn} onClick={() => addMember(newMember)}>
              Add
            </FilledButton>
          </Grid>
        </Grid>
