...
import NewUserModal from '../AdminScreens/NewUserModal'
  ...
  return (
    <Grid container justifyContent="space-between" alignItems="center">
        ...
        <Grid container spacing={1}>
          <Grid item xs={pageType !== 'companies' ? 6 : 4}>
            <StyledTextField
              ...
              placeholder="Search"
              InputProps={{
                endAdornment: <SearchIcon onClick={(e) => dispatch(setProperty({ key: 'search', value: localSearch }))} className={classes.searchIcon}  style={{cursor: 'pointer' }}/>,
              }}
            />
          </Grid>
          {pageType === 'companies' && (
      ...
      <AddButton disableRipple onClick={handleOpen} style={{ marginRight: '8px' }}>
        <AddIcon className={classes.addIcon} /> <Typography style={{ color: '#FFFFFF' }}>&nbsp;&nbsp;New&nbsp;</Typography>
      </AddButton>
      {/* </Grid> */}
