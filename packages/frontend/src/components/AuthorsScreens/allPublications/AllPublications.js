...
const publishedFieldLabels = ["Posts", "Total Words", "Average Word Count","Comments", "Views", "Shares", "Most Read", "Most Interacted"];
const publishedFields= ["posts", "total_words", "average_word_count","comments", "views", "shares", "most_read", "most_interacted"];
