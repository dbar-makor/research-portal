...
import AuthorsUsers from '../AdminScreens/AuthorsUsers'
import { useStyles } from '../../styles/MainStyles'
import SubHeader from '../Reusables/SubHeader'
import { useSelector, useDispatch } from 'react-redux'
import { selectUsersOffset, selectUsersLimit, selectUsersStatus, selectUsersSearch, setUserProperty, getUsersByTypeAsync } from '../../redux/users/usersSlice'
      ...
      <Grid item xs={10}>
        <Grid container>
          ...
          <Grid item xs={12} className={classes.marginBottom20}>
            <Grid container>
              <Grid item xs={6}>
                <Filters pageType='authorsUsers' search={userSearch} status={userStatus} setProperty={setUserProperty}/>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
