        ...
        return (
          <Grid item xs={8}>
            <Grid container>
              ...
              <Grid item xs={7}>
                <Grid container direction='row' justifyContent='flex-end' alignItems='center' style={{ marginLeft: '-25px' }}>
                  ...
                  <Grid item xs={8} style={{ paddingRight: '250px' }}>
                    <StyledTextField
                      ...
                      InputProps={{
                        endAdornment: <SearchIcon className={classes.searchIcon} style={{ cursor: 'pointer' }} />,
                      }}
                    />
                  </Grid>
                </Grid>
            ...
            <Grid container justifyContent='flex-end'>
              <Grid item>
                <Grid container alignItems='center'>
                  <Grid item>
                    <Typography style={{ fontSize: 16, color: '#fffff', cursor: 'pointer', fontWeight: 300 }} onClick={() => handleToggle('user_mgmt')}>
                      Users Managment
                    </Typography>
                  </Grid>
                  <Grid item>
                    ...
                    >
                      {openUserMgmt ? <ExpandLessIcon style={{ color: '#ffff' }} /> : <ExpandMoreIcon style={{ color: '#ffff' }} />}
                    </IconButton>
                  </Grid>
                </Grid>
                <Popper
