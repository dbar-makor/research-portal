...
import { Grid, IconButton, makeStyles, Popover, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@material-ui/core';

import ContractRow from './ContractRow';
const headersName = ['Status', 'Signaturre', 'Contract Period', 'Company', 'Country', 'Period', 'Amount', 'Yearly Cost', 'Actions'];
            ...
            {headersName.map((header, idx) => {
              return (
                <TableCell
                  ...
                  key={idx}
                  style={{
                    textAlign: header === 'Status' ? 'center' : header === 'Actions' ? 'center' : header === 'Amount' ? 'right' : header === 'Yearly Cost' ? 'right' : 'none',
                  }}
                >
                  {header}
                </TableCell>
