...
function CategoriesModal(props) {
  ...
  const { open, handleClose, currentMember, setCurrentMember, updateMemberField, memberIndex, membersRows, setMembersRows, sendMember } = props;
        ...
        <Grid container justifyContent="center" alignItems="center" className={classes.categoriesModalBox}>
          ...
          <Grid item xs={12}>
            <Grid container justifyContent="center">
              <Typography className={classes.editCats}>{currentMember.categories.length ? 'Edit Categories' : 'Add categories'}</Typography>
            </Grid>
          </Grid>
          <Grid item xs={12}>
            <Grid container justifyContent="center">
