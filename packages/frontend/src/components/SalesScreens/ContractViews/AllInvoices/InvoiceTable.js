            ...
            {headersName.map((header, idx) => {
              return (
                <TableCell
                  ...
                  key={idx}
                  style={{
                    textAlign: header === 'Amount' ? 'center' : header === 'Status' ? 'center' : header === 'Download' ? 'center' : 'none',
                  }}
                >
                  {header}
                </TableCell>
        ...
        <TableBody>
          {invoiceRows &&
            invoiceRows.map((invoice, idx) => {
              return (
                <TableRow>
                  <TableCell style={{ textTransform: 'uppercase', fontWeight: 'bold' }}>{`#${invoice.id.slice(0, 6)}`}</TableCell>
                  ...
                  <TableCell style={{ textAlign: 'center' }}>{invoice.status === 'pending' ? <Pending /> : invoice.status === 'rejected' ? <Rejected /> : <Approved />}</TableCell>
