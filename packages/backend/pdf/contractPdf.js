...
function generateContractHeader(doc, contract) {
  ...
  doc
    .font('Helvetica-Bold')
    .text('this contract is for client company name: ' + contract.company.name, 50, customerInformationTop + 60, { align: 'center' })
    .fontSize(18)
    .text(`the periodicity is: ${contract.periodicity} amount of :${contract.amount}`, 50, customerInformationTop + 75, { align: 'center' })
    .fontSize(14)
