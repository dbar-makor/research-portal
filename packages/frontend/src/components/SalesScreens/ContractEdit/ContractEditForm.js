...
function ContractEditForm(props) {
  ...
  const [inputValuePeriodicity, setInputValuePeriodicity] = useState(chargePeriods.find((p) => p.value === contract.periodicity).name);
            ...
            <Grid container className={classes.formWrapper}>
              ...
              <Grid item xs={12}>
                <Grid container>
                  ...
                  <Grid item xs={11} style={{ borderTop: '1px solid #EDEFF3', marginTop: 16, paddingBlock: '20px 5px' }}>
                        ...
                        <Typography className={classes.amountType}>
                          {contractForm.currency && contractForm.amount && contractForm.periodicity
                            ? `${contractForm.currency.symbol}
                              ${(contractForm.amount * periodToNum[contractForm.periodicity]).toLocaleString()}`
                            : '0'}
                        </Typography>
                      </Grid>
                    </Grid>
                  </Grid>
                  <Grid item xs={11} style={{ borderTop: '1px solid #EDEFF3', borderBottom: '1px solid #EDEFF3', marginTop: 16, paddingBlock: 24 }}>
                    <Grid container alignItems="center">
                      <Grid item xs={3}>
                  ...
                  <Grid item xs={11} style={{ marginTop: 10 }}>
                    <Grid container alignItems="center">
                      <Grid item>
                        <Typography style={{ fontSize: 14, color: '#868DA2' }}>*Changes will apply from next payment</Typography>
                      </Grid>
                    </Grid>
                  </Grid>
                  {/* <Grid item xs={11} style={{ marginTop: 10 }}>
