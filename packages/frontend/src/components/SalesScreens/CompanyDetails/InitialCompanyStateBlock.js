...
import { selectSearch, selectType, selectStatus, selectOffset, selectLimit, getCompaniesDataAsync } from '../../../redux/companies/companiesSlice';
          ...
          <Grid item xs={8}>
            {trialEditMode ? (
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    ...
                    style={{ width: '100%' }}
                    autoComplete="off"
                    {...(errors.sales_agent && { error: true, helperText: errors.sales_agent })}
                    // InputProps={{
              ...
              <Grid container justifyContent="flex-end">
                <Typography className={classes.fieldContent}>{props.sales_agent && props.sales_agent.name}</Typography>
              </Grid>
            )}
          </Grid>
        </Grid>
          ...
          <Grid item xs={7}>
            <Grid container justifyContent="flex-end">
              {trialEditMode ? (
                ...
                <Typography className={classes.fieldContent}>{format(new Date(props.start_at), 'dd MMM, yyyy')}</Typography>
              )}
            </Grid>
          </Grid>
        </Grid>
              ...
              <Grid item xs={7}>
                <Grid container justifyContent="flex-end">
                  {trialEditMode ? (
                    ...
                    <Typography className={classes.fieldContent}>{format(new Date(props.end_at), 'dd MMM, yyyy')}</Typography>
                  )}
                </Grid>
              </Grid>
            </Grid>
