  ...
  const periodToNum = {
    ...
    return (
        ...
        (<Grid container className={clsx({
            ...
            {props.title === 'current'
            ? <Grid item xs={props.contractStatus ? 11 : 8} style={{ marginTop: '-28px', backgroundColor: '#F9FAFB'}}>
            ...
            <Grid item xs={12} className={classes.marginBottom8}>
                <Grid container justifyContent='space-between'>
                    ...
                    <Grid item>
                        <Typography className={classes.fieldContent}>{props.contractStatus || props.title === 'last' ? props.contract.sales_agent.name : '-'}</Typography>
            ...
            <Grid item xs={12} className={classes.marginBottom8}>
                <Grid container justifyContent='space-between'>
                    ...
                    <Grid item>
                        <Typography className={classes.fieldContent}>{props.contractStatus || props.title === 'last' ? format(new Date(props.contract.start_at), 'dd MMM, yyyy') : '-'}</Typography> 
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={12} className={classes.marginBottom8}>
                <Grid container justifyContent='space-between'>
                    ...
                    <Grid item>
                        <Typography className={classes.fieldContent}>{props.contractStatus || props.title === 'last' ? props.contract.periodicity : '-'}</Typography>                        
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={12} className={classes.marginBottom8}>
                <Grid container justifyContent='space-between'>
                    ...
                    <Grid item>
                        <Typography className={classes.fieldContent}>{props.contractStatus || props.title === 'last' ? `${props.contract.currency.symbol}${props.contract.amount}` : '-'}</Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={12}>
                <Grid container justifyContent='space-between'>
                    ...
                    <Grid item>
                        <Typography className={classes.yearlyCostContent}>{props.contractStatus || props.title === 'last' ? `${
                                  props.contract.currency.symbol
                                }${(
                                    props.contract.amount *
                                  periodToNum[props.contract.periodicity]
