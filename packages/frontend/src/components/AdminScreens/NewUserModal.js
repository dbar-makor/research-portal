...
import { getUsersByTypeAsync, selectUsersLimit, selectUsersOffset, selectUsersStatus, selectUsersSearch } from '../../redux/users/usersSlice'
      ...
      <Grid container justifyContent='center'>
        ...
        <Grid item xs={12}>
          <Grid container justifyContent='center' style={{marginTop: '40px'}}>
              <FilledButton disabled={!validationResult} onClick={() => sendNewUser()}>Add</FilledButton>
          </Grid>
        </Grid>
      </Grid>
    </Dialog>
