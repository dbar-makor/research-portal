          ...
          <Grid container direction="row" justifyContent="space-between" style={{ height: '100%' }}>
            <Grid item xs={12}>
              <Grid container style={{ paddingTop: 20 }}>
                ...
                <Grid item>
                  <Grid container>
                    <Grid item xs={12} className={chosenRouteName === 'edit' ? classes.chosenRoute : classes.notChosen} onClick={() => handleRoute('edit')}>
                      {/* 
                      ** 
                      ...
                      <Grid container alignItems="center">
                        <Grid item>
                          <PersonIcon className={chosenRouteName === 'edit' ? classes.iconOn : classes.icon} />
                        </Grid>
                        <Grid item>
                    ...
                    <Grid item xs={12} className={chosenRouteName === 'settings' ? classes.chosenRoute : classes.notChosen} onClick={() => handleRoute('settings')}>
                      <Grid container alignItems="center">
                        <Grid item>
                          <SettingsIcon className={chosenRouteName === 'settings' ? classes.iconOn : classes.icon} />
                        </Grid>
                        <Grid item>
                    ...
                    <Grid item xs={12} className={chosenRouteName === 'contract_trails' ? classes.chosenRoute : classes.notChosen} onClick={() => handleRoute('contract_trails')}>
                      <Grid container alignItems="center">
                        <Grid item>
                          <InsertDriveFileIcon className={chosenRouteName === 'contract_trails' ? classes.iconOn : classes.icon} />
                        </Grid>
                        <Grid item>
            ...
            <Grid item xs={12}>
              <Grid container style={{ height: '100%' }} direction="column" justifyContent="flex-end">
                <Grid item style={{ paddingBlock: 32 }}>
                  ...
                  <Typography style={{ textAlign: 'center', display: 'flex', justifyContent: 'center', color: '#FF3939' , cursor: 'pointer'}} onClick={handleLogout}>
                    <ExitToAppIcon />
                    Logout
                  </Typography>
                </Grid>
