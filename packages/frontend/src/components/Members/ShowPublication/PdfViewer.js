...
function PdfViewer(props) {
  ...
  return (
    <Grid item xs={12}>
      ...
      <Grid container alignItems="center" justifyContent="space-evenly" className={classes.contentGrid} style={{ paddingBlock: 27 }}>
        <Grid item>
        ...
        <Grid item>
          <Grid container alignItems="center">
            ...
            <Grid item>
              <Typography onClick={() => downloadFile(pdf.file_pdf)} className={classes.contentName} style={{ cursor: 'pointer' }}>{`${pdf.file_pdf.slice(0, 19)}.pdf`}</Typography>
            </Grid>
          </Grid>
        </Grid>
      </Grid>
